                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="title_brief" class="form-control"
                                            value="{{ $product->title_brief }}" placeholder="Title Brief">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="service_note" class="form-control"
                                            value="{{ $product->service_note }}" placeholder="Service Note">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @php
                                            $selectedIndustries = collect($product->industries ?? [])
                                                ->map(fn($id) => (int) $id)
                                                ->all();
                                        @endphp
                                        <select name="industries[]" class="form-control" multiple>
                                            @foreach ($industriesCategories as $industry)
                                                <option value="{{ $industry->id }}"
                                                    {{ in_array((int) $industry->id, $selectedIndustries, true) ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="configuration_title" class="form-control"
                                            value="{{ $product->configuration_title }}" placeholder="Configuration Title">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="why_choose_title" class="form-control"
                                            value="{{ $product->why_choose_title }}" placeholder="Why Choose Title">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        @if ($product->detail_image)
                                            <img src="{{ asset('public/Product/detail_image/' . $product->detail_image) }}"
                                    ...
                                    <div class="col-md-6">
                                        @if ($product->blast_wheels_image)
                                            <img src="{{ asset('public/Product/blast_wheels_image/' . $product->blast_wheels_image) }}"
                                                alt="Blast Wheels Image"
                                                style="width:120px; height:auto; border:1px solid #ddd; padding:5px;">
                                        @endif
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary mt-2"
                                            onclick="addTitleDescRow('main-components-wrapper', 'main_components')">Add
                                            Component</button>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div id="tech-spec-wrapper"></div>
                                        <button type="button" class="btn btn-sm btn-outline-primary mt-2"
                                            onclick="addTechSpecRow()">Add Parameter</button>
                                    </div>
                                    <div class="col-md-12 mt-4">
                                        <label class="form-label">Technical Details</label>
                                        <textarea id="technical_details" name="technical_details" class="form-control">{!! $product->technical_details !!}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary mt-2"
                                            onclick="addFaqRow()">Add FAQ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
                    $('#meta_description,#short_description,#working_principle_desc,#configuration_description,#why_choose_description,#optional_accessories_desc,#faqs_desc,#related_industries_desc,#advantages_desc,#technical_details')
                        .summernote({
                            ...
                            hydrateSimpleList('design-features-wrapper', 'design_features', 'Design Feature',
                                designFeatures);
                            hydrateSimpleList('selection-guidelines-wrapper', 'selection_guidelines', 'Guideline',
                                selectionGuidelines);
                            hydrateSimpleList('optional-features-wrapper', 'optional_features', 'Optional Feature',
                                optionalFeatures);
                            hydrateTitleDesc('operational-accessories-wrapper', 'operational_accessories',
                                operationalAccessories);
                            hydrateFaqs(faqs);
                        });
