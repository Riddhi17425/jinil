...
<section class="navi_page">
    <div class="container-fluid">
        <div class="navi_page_child">
            <div>
                <p class="title_24"><a href="{{ url('/') }}" class="text-585">Home</a> / <a href="{{ route('blogs') }}" class="text-585">Blogs</a> / {{ $blogsdetail->title }}</p>
            ...
            <a href="{{ route('contact') }}" class="contact_circle">
                ...
                <svg class="arrow_img" width="18" height="23" viewBox="0 0 18 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.85653 1.15617L8.85653 20.9552L8.85653 1.15617ZM8.85653 20.9552L16.5562 13.2555L8.85653 20.9552ZM8.85653 20.9552L1.15692 13.2556L8.85653 20.9552Z" fill="#58595B" />
                    <path d="M8.85653 1.15617L8.85653 20.9552M8.85653 20.9552L16.5562 13.2555M8.85653 20.9552L1.15692 13.2556" stroke="#58595B" stroke-width="2.31318" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </a>
        </div>
    </div>
            ...
            <div class="blog-guide-section">
                ...
                <div class="blog-content">
                    ...
                    <div class="blog-content-section" id="conclusion">
                        <h2>Conclusion</h2> {!! $blogsdetail->conclusion !!}
                    </div>

                    <!-- Author Box -->
                    @if($blogsdetail->author)
                        <div class="author-box rounded p-4" id="author-profile">

                            <!-- Avatar -->
                            <div class="author-avatar position-relative flex-shrink-0">
                                @if($blogsdetail->author->thumbnail_image)
                                    <img class="author-avatar-img"
                                        src="{{ asset('public/Authors/thumbnail_image/' . $blogsdetail->author->thumbnail_image) }}"
                                        alt="{{ $blogsdetail->author->name }}">
                                @elseif($blogsdetail->author->main_image)
                                    <img class="author-avatar-img"
                                        src="{{ asset('public/Authors/main_image/' . $blogsdetail->author->main_image) }}"
                                        alt="{{ $blogsdetail->author->name }}">
                                @else
                                    <img class="author-avatar-img"
                                        src="https://ui-avatars.com/api/?name={{ urlencode($blogsdetail->author->name) }}&size=100&background=e8f0fb&color=105293"
                                        alt="{{ $blogsdetail->author->name }}">
                                @endif
                            </div>
                            ...
                            <div class="author-info">
                                <h4 class="author-name d-flex align-items-center m-0 mb-2">
                                    <a href="{{ route('author.detail', ['slug' => $blogsdetail->author->slug]) }}">
