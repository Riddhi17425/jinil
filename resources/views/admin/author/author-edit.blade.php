...
<div class="container-xxl">
    ...
    <div class="row align-items-center mb-4">
        <div class="col">
            <h3 class="fw-bold mb-0">Edit Author</h3>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('author.update', $data->id) }}"
                  method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('social_media_name', $data->social_media_name) }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if($data->social_media_image)
                            <div class="mb-2">
                                <img src="{{ asset('public/Authors/social_media_image/'.$data->social_media_image) }}"
                                    class="img-thumbnail"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if($data->main_image)
                            <div class="mb-2">
                                <img src="{{ asset('public/Authors/main_image/'.$data->main_image) }}"
                                     class="img-thumbnail"
                                     style="width:100px;height:100px;object-fit:cover;">
                            </div>
                        @endif
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if($data->thumbnail_image)
                            <div class="mb-2">
                                <img src="{{ asset('public/Authors/thumbnail_image/'.$data->thumbnail_image) }}"
                                     class="img-thumbnail"
                                     style="width:100px;height:100px;object-fit:cover;">
                            </div>
                        @endif
                ...
                <div class="mt-3">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="icofont-save me-1"></i> Update Author
                    </button>
